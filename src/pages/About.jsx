...
function About() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Pixels : A team made with full of Developers.</p>
    </div>
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">Prashant Kumar Yadav</h2>
            <h3 class="text-gray-500 mb-3">Backend Developer || UI Developer</h3>
